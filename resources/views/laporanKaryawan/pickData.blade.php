...
<head>
    ...
    <title>Rekap Data Penjualan Berdasarkan Karyawan</title>
</head>
<body>
                    ...
                    <div class="col-md-6">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title"> Pemilihan Durasi untuk Data Penjualan Berdasarkan Karyawan Terjual</h3>
                            </div>
                            <form action="{{ route('prosesKRY') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
