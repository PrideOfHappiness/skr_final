        ...
        <div class="mt-4"> 
            <section class="content"> 
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="wilayah_asal" name="wilayah_asal" value="{{ $pengiriman->fj->konsumen->nama }}" readonly>
                </div>
                <div class="mb-3">
                    <label for="alamat" class="form-label">Alamat Konsumen</label>
                    <input type="text" class="form-control" id="alamat" name="alamat" value="{{ $pengiriman->fj->konsumen->alamat }}" readonly>
                </div>
                <div class="mb-3">
                    <label for="kecamatan" class="form-label">Sepeda Motor Yang Dikirim</label>
                    <input type="text" class="form-control" id="kecamatan" name="kecamatan" value="{{ $pengiriman->fj->barang->nama_barang }}" readonly>
                </div>
                <div class="mb-3">
                    <label for="no_ktp" class="form-label">Karyawan Yang Mengirim</label>
                    <input type="text" class="form-control" id="no_ktp" name="no_ktp" value="{{ $pengiriman->pengirim->nama_karyawan }}" readonly>
                </div>
                <div class="mb-3">
                    <label for="no_telp" class="form-label">Perlengkapan</label>
                    <textarea name="perlengkapan" class="form-control" rows="4" readonly>{{ $pengiriman->perlengkapan }}</textarea>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="harga" name="harga" value="{{ date('j F Y G:i:s', strtotime($pengiriman->pdi_datetime)) }}" readonly>
                </div>
                <div class="mb-3">
                    <label for="harga" class="form-label">Waktu Pengiriman</label>
                    <input type="text" class="form-control" id="harga" name="harga" value="{{ date('j F Y G:i:s', strtotime($pengiriman->shipping_datetime)) }}" readonly>
                </div>
                <div class="mb-3">
                    <label for="harga" class="form-label">Waktu Selesai</label>
                    <input type="text" class="form-control" id="harga" name="harga" value="{{ date('j F Y G:i:s', strtotime($pengiriman->selesai_datetime)) }}" readonly>
                </div>
                <div class="mb-3">
